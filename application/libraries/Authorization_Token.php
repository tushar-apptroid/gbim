...
class Authorization_Token 
{
    ...
    public function generateToken($data = null)
    {
        if ($data && is_array($data))
        {
            ...
            $data['API_TIME'] = time();
            $data['token_expire_time'] = $data['API_TIME'] + $this->token_expire_time;
    ...
    {
        // var_dump(!empty($headers) && is_array($headers) && isset($headers[$this->token_header]));
        // print_r($headers);exit;

        if(!empty($headers) && is_array($headers) && isset($headers[$this->token_header])) 
        {
